			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="grid lg:grid-cols-2 gap-12">
					...
					<div className="space-y-8">
						<div className="bg-white rounded-3xl shadow-xl p-8">
							<h2 className="text-2xl font-bold mb-6">{t('contacts.info.title')}</h2>
							...
							<div className="space-y-6">
								<div className="flex items-start gap-4">
									...
									<div>
										...
										<p className="text-gray-600">{t('contacts.info.address')}</p>
									</div>
								</div>
								...
								<div className="flex items-start gap-4">
									...
									<div>
										...
										<p className="text-gray-600">+998 77 480-99-99</p>
										<p className="text-gray-600">+998 77 480-22-22</p>
									</div>
								</div>
								...
								<div className="flex items-start gap-4">
									...
									<div>
										...
										<p className="text-gray-600">info@belvest.uz</p>
									</div>
								</div>
								...
								<div className="flex items-start gap-4">
									...
									<div>
										<h3 className="font-medium text-gray-900 mb-1">Время работы</h3>
										<p className="text-gray-600">{t('contacts.info.workTime')}</p>
									</div>
								</div>
							</div>
						</div>
						...
						{/* Social Links */}
						<div className="bg-white rounded-3xl shadow-xl p-8">
							<h2 className="text-2xl font-bold mb-6">{t('contacts.info.social')}</h2>
							<div className="flex gap-4">
								{['Facebook', 'Instagram', 'Telegram', 'YouTube'].map((social) => (
									<a
										key={social}
										href="#"
										className="bg-emerald-100 text-emerald-600 w-12 h-12 rounded-lg flex items-center justify-center hover:bg-emerald-600 hover:text-white transition-colors"
									>
